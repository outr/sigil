 ...
 * operate over them.
 */
case object CreateContainerTool extends TypedOutputTool[CreateContainerInput, CreateContainerOutput](
  ...
  override protected def executeTyped(input: CreateContainerInput,
