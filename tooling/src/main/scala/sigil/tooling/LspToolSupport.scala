...
trait LspToolSupport extends sigil.tool.Tool {
  ...
  protected def withSessionTyped[Output](languageId: String,
                                         filePath: String,
                                         context: ToolContext,
                                         onError: String => Output)(body: (LspSession, String, String) => Task[Output]): Task[Output] =
  ...
  private def withSessionTypedResolved[Output](
    languageId: String,
    filePath: String,
    context: ToolContext,
    onError: String => Output)(body: (LspSession, String, String) => Task[Output]): Task[Output] =
  ...
  protected def withOpenDocumentTyped[Output](languageId: String,
                                              filePath: String,
                                              context: ToolContext,
                                              onError: String => Output)(body: (LspSession, String) => Task[Output]): Task[Output] =
  ...
  protected def withSessionOrThrow[Output](languageId: String,
                                           filePath: String,
                                           context: ToolContext)(body: (LspSession, String, String) => Task[Output]): Task[Output] =
  ...
  protected def withOpenDocumentOrThrow[Output](languageId: String,
                                                filePath: String,
                                                context: ToolContext)(body: (LspSession, String) => Task[Output]): Task[Output] =
