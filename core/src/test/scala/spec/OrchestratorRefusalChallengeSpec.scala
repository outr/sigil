    ...
    override def call(input: ProviderCall): Stream[ProviderEvent] = {
      ...
      Stream.emits(List(
        ...
        ProviderEvent.toolCall(
          callId,
          RespondTool)(RespondInput(topicLabel = "Refusal", topicSummary = "challenge spec", content = content, endsTurn = true)),
      ...
      if (n == 1) {
        ...
        Stream.emits(List(
          ...
          ProviderEvent.toolCall(callId, RespondTool)(RespondInput(
            topicLabel = "After Discovery",
            topicSummary = "informed refusal",
  ...
  final private class AlwaysRefuseProvider(content: String) extends Provider {
    ...
    override def call(input: ProviderCall): Stream[ProviderEvent] = {
      ...
      Stream.emits(List(
        ...
        ProviderEvent.toolCall(
          callId,
          RespondTool)(RespondInput(topicLabel = "Refusal", topicSummary = "stubborn refusal", content = content, endsTurn = true)),
        ProviderEvent.Done(StopReason.Complete)
      ))
    }
  }
