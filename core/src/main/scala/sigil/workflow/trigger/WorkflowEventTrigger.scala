 ...
 */
final case class WorkflowEventTrigger(eventName: String) extends WorkflowTrigger derives RW {
...
object WorkflowEventTrigger {
   ...
   */
  final private case class QueueState(queue: ConcurrentLinkedQueue[Json], refCount: Int)
