...
object MetalsBoostedToolNames {
  val lsp: List[ToolName] = List(
    ...
    "lsp_goto_definition", "lsp_type_definition", "lsp_implementation",
    "lsp_find_references",
    "lsp_hover", "lsp_signature_help", "lsp_completion",
    "lsp_document_symbols", "lsp_workspace_symbols",
    "lsp_code_action", "lsp_apply_code_action",
    "lsp_format", "lsp_format_range",
    "lsp_rename", "lsp_prepare_rename",
    "lsp_did_change",
  ...
  val bsp: List[ToolName] = List(
    ...
    "bsp_list_targets", "bsp_sources", "bsp_inverse_sources",
