...
import sigil.tooling.{
  LspManager, LspServerConfig, LspSession, LspWorkspaceSymbolsInput, LspWorkspaceSymbolsTool, PermissiveWorkspaceEditApplier, SymbolHit
}
...
class MetalsLiveBootstrapSpec extends AsyncWordSpec with AsyncTaskSpec with Matchers {
  ...
  implicit override val testTimeout: FiniteDuration = 8.minutes
