# AgentDojo banking — openai/gpt-5.4-mini
...
| Metric | Score |
|---|---|
| Baseline utility (no attack)   | 37.5% (16 user tasks) |
| Injected utility (with attack) | 34.0% (16 × 9 cells) |
| TASR (attack success rate)     | 3.5% |
| Defense rate (1 − TASR)        | 96.5% |
